...
NOTE: APIを通じて利用できるアクセスタイプの中には、Element UIでは利用できないものがあります。
...
|===
.関連情報
link:../storage/concept_system_manage_manage_cluster_administrator_users.html#view-cluster-admin-details["Element UI で利用可能なアクセスタイプについて説明します。"]
