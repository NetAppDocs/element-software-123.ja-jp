...
+
image::../media/element_new_ldap_servers.jpg[[LDAPサーバ]ビューの一般設定]
...
.. [* ユーザー * （ * User * ） ] > [* 表示（ * View ） ]
+
image::../media/element_new_cluster_admin.jpg[新しいユーザービューの作成]
...
* link:concept_system_manage_manage_cluster_administrator_users.html#create-a-cluster-administrator-account["クラスタ管理者アカウントを作成"]
* link:concept_system_manage_manage_ldap.html#view_ldap_details["LDAP の詳細"]
